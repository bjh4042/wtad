...
export interface QuickPanelProps {
  ...
  setNotifDrag: (v: any) => void;
  readNotifIds: number[];
  setReadNotifIds: (v: any) => void;
  wifi: boolean;
  setWifi: (v: any) => void;
  wifiConnected: string | null;
  setWifiConnected: (v: any) => void;
  wifiModalOpen: boolean;
  setWifiModalOpen: (v: any) => void;
  wifiPasswordInput: string;
  setWifiPasswordInput: (v: any) => void;
  wifiPassword: string;
  setWifiPassword: (v: any) => void;
  bluetooth: boolean;
  setBluetooth: (v: any) => void;
  connectedBtDevice: string | null;
  setBluetoothModalOpen: (v: any) => void;
  airplane: boolean;
  setAirplane: (v: any) => void;
  darkMode: boolean;
  ...
  soundMode: string;
  setSoundMode: (v: any) => void;
  setPhotos: (v: any) => void;
  setCurrentApp: (v: any) => void;
  setSettingsMenu: (v: any) => void;
}
